...
'''con=mysql.connector.connect(host="localhost",user="hospitaluser",password="Hospital@123",database="Hospital")#connection to mysql
cur=con.cursor() out put only registstion and appniment are open all details are not open 
...
root=Tk()
label=Label(root,text="Prasad HOSPITAL",font="arial 40 bold",bg='light blue')
